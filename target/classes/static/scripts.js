/**
 * Send request to the backed, get an HTML fragment from a specific page,
...
async function showPage(pageName) {
    ...
    if (response.ok) {
        ...
        httpResponseBody = "<p class='error'>Could not load from the backend, contact the admin (code: " + response.status + ")<p>";
    }
